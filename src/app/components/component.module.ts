...
@NgModule({
  ...
  imports: [
    ...
    RouterModule,
    DragDropModule,
    MatTreeModule, MatTooltipModule, MatToolbarModule, MatTabsModule, MatSortModule,
    MatSnackBarModule, MatSlideToggleModule, MatSliderModule, MatSidenavModule,
    MatSelectModule, MatProgressSpinnerModule, MatProgressBarModule, MatPaginatorModule,
    MatNativeDateModule, MatRippleModule, MatListModule, MatGridListModule,
    MatExpansionModule, MatDividerModule, MatDatepickerModule, MatStepperModule,
    MatChipsModule, MatCheckboxModule, MatCardModule, MatButtonToggleModule,
    MatBottomSheetModule, MatBadgeModule, MatAutocompleteModule,
    MatButtonModule, MatMenuModule, MatIconModule, MatDialogModule,
    MatRadioModule, MatTableModule, MatFormFieldModule, MatInputModule,
  ],
  exports: [
    MatDatepickerModule,
    AdicionarPessoaComponent,
